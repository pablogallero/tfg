...
<img class=" img-fluid mx-auto w-50 h-50 mb-5 "   src="images/<?= $proyecto->getImagen() ?>" alt="Generic placeholder image"> 
          ...
          <?php if( isset($_SESSION['rol']) && $_SESSION['rol']== "administrador"){ ?>
            <button type="button" class="btn btn-warning" onclick="window.location.href='index.php?controller=proyectos&amp;action=edit&amp;id=<?=$proyecto->getId() ;?>'"><?= i18n("Modificar")?></button>
        <button type="button" class="btn text-center btn-danger " data-toggle="modal" data-target="#modalDeleteProyecto<?=$proyecto->getId() ;?>"><?= i18n("Eliminar")?></button>
            ...
            <div class="col-9 px-0 mx-auto modal-content">
                ...
                <div>
                    <div class="mx-auto px-0 cuerpoModal modal-body ">
                        <p class="p-5"><?= i18n("¿Estás segur@ de querer borrar este proyecto?")?></p>
                    </div>
                    <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick="window.location.href='index.php?controller=proyectos&action=delete&id=<?= $proyecto->getId()?>'"><?= i18n("Eliminar")?></button>
