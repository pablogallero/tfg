                            ...
                            <div class="controls">
                                ...
                                <div class="row">
                                    ...
                                    <h3 class="display-3 titulovideos"><?= i18n("¿Qué es?")?></h3> 
                                        <div class="form-group">   <textarea rows="15" name="introduccion" onblur="validarVacio(this.id)" class="widgEditor" id="mytextarea"><?=nl2br( $proyecto->getIntroduccion()) ?></textarea> </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <h3 class="display-3 titulovideos"><?= i18n("Objetivos")?></h3> 
                                        <div class="form-group">   <textarea rows="15" name="objetivos" onblur="validarVacio(this.id)"  class="widgEditor" id="mytextarea1"><?=nl2br( $proyecto->getObjetivos()) ?></textarea> </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <h3 class="display-3 titulovideos"><?= i18n("Metodología")?></h3> 
                                        <div class="form-group">   <textarea rows="15" name="metodologia" onblur="validarVacio(this.id)" class="widgEditor" id="mytextarea2"><?=nl2br( $proyecto->getMetodologia()) ?></textarea> </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <h3 class="display-3 titulovideos"><?= i18n("Conclusiones")?></h3> 
                                        <div class="form-group">   <textarea rows="15" name="conclusiones" onblur="validarVacio(this.id)" class="widgEditor" id="mytextarea3"><?=nl2br( $proyecto->getConclusiones()) ?></textarea> </div>
                                    </div>
