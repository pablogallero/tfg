                    ...
                    <div class="container">
                        <form id="contact-form" role="form" action="index.php?controller=noticias&amp;action=edit&amp;id=<?=$noticia->getId() ?>" onsubmit="return validarformularionoticias()" method="POST" enctype="multipart/form-data">
                            <div class="controls">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group"> <label for="cuerponoticia"><?= i18n("Cuerpo noticia")?></label> <textarea id="cuerponoticia" onblur="validarVacio(this.id)" name="cuerponoticia" class="form-control" placeholder="<?= i18n("Introduzca aquí el cuerpo de la noticia")?>" rows="12"  > <?= nl2br($noticia->getCuerponoticia())?></textarea> </div>
                                    </div>
