        ...
        <div class="col-lg-7 mx-auto">
            <div class="card mt-2 mx-auto p-4 bg-light">
                <div class="card-body bg-light">
                    <div class="container">
                        <form id="contact-form" role="form" action="index.php?controller=contactos&amp;action=edit&amp;id=<?= $contacto->getId() ?>" onsubmit="return validarformulariocontacto()" method="POST">
                            <div class="controls">
