                    ...
                    <div class="container">
                        <form id="contact-form" role="form" action="index.php?controller=comocolaborar&amp;action=edit&amp;id=<?=$contenido->getId() ?>" onsubmit="return validarformulariocolaborar()" method="POST">
                            <div class="controls">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group"> <label for="descripcion"><?= i18n("Descripción")?></label>  <textarea rows="15" name="descripcion" id="mytextarea" onblur="validarVacio(this.id)"><?=nl2br( $contenido->getDescripcion()) ?></textarea> </div>
                                    </div>
